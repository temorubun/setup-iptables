...
# Atur kebijakan default untuk memblokir semua koneksi yang masuk dan keluar
...
sudo iptables -A OUTPUT -p tcp --sport 7031 -j ACCEPT

# Izinkan koneksi UDP pada port 7031
sudo iptables -A INPUT -p udp --dport 7031 -j ACCEPT
sudo iptables -A OUTPUT -p udp --sport 7031 -j ACCEPT
